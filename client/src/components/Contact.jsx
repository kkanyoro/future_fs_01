...
const Contact = () => {
    ...
    return (
        <>
            <section id="contact" className="min-h-screen snap-start flex flex-col items-center justify-center bg-space-black relative py-24">
                    ...
                    <Reveal>
                        <div className="w-full max-w-2xl mx-auto">
                            <div className="text-center mb-12">
                                <h2 className="text-gray-accent font-mono tracking-widest mb-4 uppercase text-sm">
                                    // What's Next?
                                </h2>
            ...
            {/* BIG FOOTER */}
            <footer className="w-full bg-slate-900/40 border-t border-white/5 py-12 px-6 z-10 relative backdrop-blur-md snap-end">
                <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-8">
                    ...
                    {/* Copyright*/}
                    <div className="text-slate-500 text-sm md:text-base font-mono text-center mt-4">
